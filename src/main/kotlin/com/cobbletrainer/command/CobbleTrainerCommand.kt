                        ...
                        .then(argument("id", StringArgumentType.word())
                            ...
                            .executes { ctx ->
                                ...
                                if (removed) {
                                    ...
                                    ctx.source.sendFeedback({ Text.literal("§aTrainer §f$id§a removed from config.") }, true)
                                } else {
                                    ctx.source.sendError(Text.literal("§cTrainer '$id' not found."))
                                }
                                if (removed) 1 else 0
                    ...
                    .then(literal("spawn")
                        ...
                        .then(argument("id", StringArgumentType.word())
                            ...
                            .executes { ctx ->
                                ...
                                val id = StringArgumentType.getString(ctx, "id")
                                val result = TrainerManager.spawnTrainer(player, id)
                                when (result) {
                        ...
                        .executes { ctx ->
                            ctx.source.sendFeedback({
                                Text.literal(
                                    ...
                                    "§e/cobbletrainer remove §7<id> §f— Remove trainer from config\n" +
                                    "§e/cobbletrainer spawn §7<id> §f— Spawn static NPC\n" +
                                    "§e/cobbletrainer delete §f— Delete the NPC entity in front of you\n" +
